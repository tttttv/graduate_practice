...
from keras.src.utils.version_utils import training
...
class ArcFace(RecognitionModel):
    def __init__(self):
        ...
        path = os.path.dirname(os.path.abspath(__file__)) + "/weights/arcface_weights.h5"
